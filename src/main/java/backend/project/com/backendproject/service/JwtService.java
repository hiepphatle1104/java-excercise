...
import backend.project.com.backendproject.dto.GeneratedToken;
import backend.project.com.backendproject.dto.JwtPayload;
...
import backend.project.com.backendproject.repository.RedisTokenRepository;
...
public class JwtService {
    ...
    public NewTokenResponse createNewToken(NewTokenRequest refreshToken) throws ParseException, JOSEException {
        ...
        GeneratedToken newRefreshToken = generateRefreshToken(user);
